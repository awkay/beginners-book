...
To see why this isn't commonly done, let's see the data evolve over time. Say at one point in the game Vlad aka Sally has the Sword of Destiny, which
has a back-reference:
...
and Vlad decides to give this sword to their sidekick. If the logic of the program isn't perfect, it could be easy to *forget* to update the back reference, leading to something inconsistent like this:
